...
var _easyRequests = __webpack_require__(338);
...
var Post = function (_Service) {
  ...
  //Endpointname depends of class name
  function Post() {
    ...
    _this.config.endpoint = '/users'; // we override endpoint default name to, http://localhost:8000/my-posts 
    _this.config.origin = 'https://jsonplaceholder.typicode.com/';
    return _this;
  }

  _createClass(Post, null, [{
    key: "getUnpublishedPosts",
    value: function getUnpublishedPosts(params) {
      var PostI = new Post();
      var route = PostI.buildUrl(); //+ "/unpublished-posts"; //http://localhost:8000/my-posts/unpublished-posts 
    ...
    key: "unpublishedPosts",
    value: function unpublishedPosts(params) {
      var PostI = new Post();

      var route = PostI.buildUrl(); //http://localhost:8000/my-posts/unpublished-posts 
  ...
  return Post;
}(_easyRequests.Service);

//Use it with async/await ES7!!

function getMyPosts() {
  var postsList = Post.unpublishedPosts(); //Get Post collection
  postsList.then(function (success) {
...
var User = function (_Trait$with) {
  _inherits(User, _Trait$with);
  ...
  function User() {
    ...
    _this2.config.endpoint = 'users';
    _this2.config.origin = 'https://jsonplaceholder.typicode.com/';
    _this2.defineColumns(['id', 'name', 'username', 'phone', 'email']);
    return _this2;
  }

  return User;
}((0, _easyRequests.Trait)(_easyRequests.Service).with(_easyRequests.Model));
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(334);
...
var createError = __webpack_require__(335);
...
var _TraitBuilder = __webpack_require__(339);

var _Model = __webpack_require__(340);

var _Model2 = _interopRequireDefault(_Model);

var _BaseService = __webpack_require__(341);
...
var TraitBuilder = function () {
  function TraitBuilder(superclass) {
    _classCallCheck(this, TraitBuilder);
  ...
  _createClass(TraitBuilder, [{
    ...
    value: function _with() {
      ...
      return traits.reduce(function (c, trait) {
        return trait(c);
      }, this.superclass);
    }
  }]);
...
var trait = exports.trait = function trait(superclass) {
  return new TraitBuilder(superclass);
};
...
var BaseModel = function BaseModel(superclass) {
  return function (_superclass) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class2.__proto__ || Object.getPrototypeOf(_class2)).call.apply(_ref, [this].concat(args))), _this), _this.props = [], _this.attributes = {}, _this._isBeingDeleted = false, _this._isBeingCreated = true, _this._isDeleted = false, _this._exists = false, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(_class2, [{
      key: 'defineColumns',
      value: function defineColumns(columns) {
      ...
      value: function save() {
        ...
        var form = this.beforeSave();
        if (this.attributes.id) {
          return this.update();
        }
        this._isBeingCreated = true;
        return new Promise(function (resolve, reject) {
          _this2.createResource(form).then(function (response) {
            _this2.fill(_this2.dataToFillAfterSave(response));
            _this2._setItemExistence(true);
            _this2._isBeingCreated = false;
            resolve(response);
          }).catch(function (error) {
            _this2._isBeingCreated = false;
            reject(error);
      ...
      value: function update() {
        ...
        var form = this.beforeUpdate();
        var id = form.id;

        this._isBeingUpdated = true;
        return new Promise(function (resolve, reject) {
          _this3.updateResource(id, form).then(function (response) {
            _this3._isBeingUpdated = false;
            _this3.fill(_this3.dataToFillAfterUpdate(response));
            resolve(response);
          }).catch(function (error) {
            _this3._isBeingUpdated = false;
            reject(error);
      ...
      value: function destroy() {
        ...
        var form = this.beforeDestroy();
        var id = form.id;

        this._isBeingDeleted = true;
        return new Promise(function (resolve, reject) {
          _this4.deleteResource(id).then(function (response) {
            _this4._isBeingDeleted = false;
            _this4._setItemExistence(false);
            resolve(response);
          }).catch(function (error) {
            _this4._isBeingDeleted = false;
            reject(error);
      ...
      key: 'dataToFillAfterSave',
      value: function dataToFillAfterSave(axiosResponse) {
        // { "data":{ ... },"status":XXX,"statusText":"","headers":{ ... }","content-type":"application/json  .. etc} ;
        return axiosResponse.data;
      }
    }, {
      key: 'dataToFillAfterUpdate',
      value: function dataToFillAfterUpdate(axiosResponse) {
        // { "data":{ ... },"status":XXX,"statusText":"","headers":{ ... }","content-type":"application/json  .. etc} ;
        return axiosResponse.data;
      }
    }, {
      ...
      value: function serialize() {
        var attributes = this.beforeSerialize();
        return attributes;
      }
    }, {
      key: 'beforeSerialize',
      value: function beforeSerialize() {
      ...
      key: 'itemExists',
      value: function itemExists() {
        return this.attributes.id || false;
      }
    }, {
      key: '_checkExistence',
      value: function _checkExistence(data) {
        if (!data) {
      ...
      key: '_setItemExistence',
      value: function _setItemExistence() {
        ...
        if (this.props.constructor === Array) {
          if (this.props.length > 0) {
            this.props.forEach(function (prop) {
              if (typeof _this5[prop] === 'undefined') {
                _this5._defineNewProperty(prop);
                _this5.attributes[prop] = null;
              }
            });
            if (data) {
              this.fill(data);
          ...
          if (JSON.stringify(this.props) === '{}') {
            ...
            props.forEach(function (prop) {
              ...
              // Set defaults
              if (_this5.props[prop].default) {
                _this5.attributes[prop] = _this5.props[prop].default;
              }
            });
            if (data) {
              this.fill(data);
      ...
      key: '_defineNewProperty',
      value: function _defineNewProperty(attribute) {
        var self = this;
        var setgetter = {
          get: function get() {
...
var _axios = __webpack_require__(342);

var _axios2 = _interopRequireDefault(_axios);

var _pluralize = __webpack_require__(362);
...
var Service = function () {
  ...
  function Service() {
    ...
    this.config = {
      ...
      prefix: '',
      endpoint: (0, _pluralize2.default)((0, _lodash.kebabCase)(this.getClassName())).toLowerCase()
    };
  }
  ...
  _createClass(Service, [{
    ...
    value: function getResource() {
      ...
      var promise_request = new Promise(function (resolve, reject) {
        _this.http.get(route, {
          ...
          resolve(_this.fetched(response));
        }).catch(function (error) {
          reject(error);
        });
      });
    ...
    value: function updateResource(id, data) {
      ...
      var resource_promise = new Promise(function (resolve, reject) {
        _this4.http.put(endpoint, data).then(function (response) {
          resolve(_this4.updated(response));
        }).catch(function (err) {
          reject(err);
        });
      });
    ...
    key: 'handleRequest',
    value: function handleRequest(data, hookName) {
      var _this6 = this;
...
var defaults = __webpack_require__(332);
...
axios.Cancel = __webpack_require__(337);
...
var Cancel = __webpack_require__(337);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(90), __webpack_require__(364)(module)))
